...
class DLPPrinterGUI(QWidget):
    ...
    def __init__(self, dlp_controller=None, parent=None, printer_setup='BOTTOM-UP'):
        ...
        self.dlp_controller.super_job_settings_updated.connect(self.update_super_job_parameters)
        self.dlp_controller.super_job_loaded.connect(self.update_super_job_loaded_status)
...
#        print(self.__left_layout.sizeHint(), self.__right_layout.sizeHint())
    ...
    def __init_projector_widget__(self, parent=None):
        ...
        self.mirror_x.setChecked(self.dlp_controller.is_horizontal_mirrored())
        self.mirror_x.toggled.connect(self.dlp_controller.set_horizontal_mirroring)
        self.mirror_y = QCheckBox("Mirror Y")
        self.mirror_y.setChecked(self.dlp_controller.is_vertical_mirrored())
        self.mirror_y.toggled.connect(self.dlp_controller.set_vertical_mirroring)
        ...
        projector_layout.addWidget(self.mirror_x, 0, 1)
        projector_layout.addWidget(self.mirror_y, 0, 2)
    ...
    def __init_advanced_features_widget__(self, parent=None):
        ...
        starting_amplitude_edit.setMaximum(1600)
        ...
        amplitude_step_edit.setMaximum(1600)
        ...
        self.apply_grayscale_correction_check = QCheckBox("Grayscale Correction", self.__advanced_widget)
        self.apply_grayscale_correction_check.setChecked(self.dlp_controller.grayscale_correction)
        self.apply_grayscale_correction_check.toggled.connect(self.dlp_controller.set_grayscale_correction)
        grayscale_parameters_widget = QWidget(self.__features_widget)
        a_parameter_label = QLabel("\u03B1", grayscale_parameters_widget)
        self.alpha_parameter_edit = QDoubleSpinBox(grayscale_parameters_widget)
        self.alpha_parameter_edit.setMaximum(1000)
        self.alpha_parameter_edit.setMinimum(0)
        self.alpha_parameter_edit.setDecimals(3)
        self.alpha_parameter_edit.setSingleStep(0.001)
        self.alpha_parameter_edit.valueChanged.connect(self.dlp_controller.set_grayscale_alpha)
        self.alpha_parameter_edit.setValue(self.dlp_controller.grayscale_alpha)
        beta_parameter_label = QLabel("\u03B2", grayscale_parameters_widget)
        self.beta_parameter_edit = QDoubleSpinBox(grayscale_parameters_widget)
        self.beta_parameter_edit.setMaximum(1000)
        self.beta_parameter_edit.setMinimum(0)
        self.beta_parameter_edit.setDecimals(3)
        self.beta_parameter_edit.setSingleStep(0.001)
        self.beta_parameter_edit.valueChanged.connect(self.dlp_controller.set_grayscale_beta)
        self.beta_parameter_edit.setValue(self.dlp_controller.grayscale_beta)
        gamma_parameter_label = QLabel("\u03B3", grayscale_parameters_widget)
        self.gamma_parameter_edit = QDoubleSpinBox(grayscale_parameters_widget)
        self.gamma_parameter_edit.setMaximum(1000)
        self.gamma_parameter_edit.setMinimum(0)
        self.gamma_parameter_edit.setDecimals(3)
        self.gamma_parameter_edit.setSingleStep(0.001)
        self.gamma_parameter_edit.valueChanged.connect(self.dlp_controller.set_grayscale_gamma)
        self.gamma_parameter_edit.setValue(self.dlp_controller.grayscale_gamma)
        ...
        grayscale_parameters_layout.addWidget(self.alpha_parameter_edit)
        grayscale_parameters_layout.addWidget(beta_parameter_label)
        grayscale_parameters_layout.addWidget(self.beta_parameter_edit)
        grayscale_parameters_layout.addWidget(gamma_parameter_label)
        grayscale_parameters_layout.addWidget(self.gamma_parameter_edit)
        ...
        advanced_features_layout.addWidget(self.apply_grayscale_correction_check, 7, 0, 1, 2)
    ...
    def __init_start_stop_widget__(self, parent=None):
        ...
        self.load_job_file_button = QPushButton("Load SuperJob", self.__start_stop_widget)
        self.load_job_file_button.clicked.connect(self.load_super_job_file)
        ...
        start_stop_layout.addWidget(self.load_job_file_button, 1, 0)
    ...
    def __init_preview_widget__(self, parent=None):
        ...
        self.__preview_widget.setMinimumSize(size.width(), size.height()/2.7)
        self.__preview_widget.setSizePolicy(QSizePolicy.Minimum, QSizePolicy.Fixed)
    ...
    @Slot()
    def load_super_job_file(self):
        file_name = QFileDialog.getOpenFileName(caption='Select job file', dir='../',
                                                  filter="Job Files (*.json)")
        self.dlp_controller.load_super_job_file(file_name[0])
    ...
    @Slot()
    def update_super_job_parameters(self):
        self.apply_grayscale_correction_check.setChecked(self.dlp_controller.grayscale_correction)
        self.alpha_parameter_edit.setValue(self.dlp_controller.grayscale_alpha)
        self.beta_parameter_edit.setValue(self.dlp_controller.grayscale_beta)
        self.gamma_parameter_edit.setValue(self.dlp_controller.grayscale_gamma)
    ...
    @Slot(bool)
    def update_super_job_loaded_status(self, status):
        if status:
            self.load_job_file_button.setStyleSheet("QPushButton {background-color: lightgreen;}")
        else:
            self.load_job_file_button.setStyleSheet("")
